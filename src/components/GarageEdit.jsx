...
const EditGarage = () => {
    ...
    useEffect(()=>{
      updateFormData(garage);
    //   userEmail = garage.email;
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`http://localhost:7070/api/garage/${userEmail}/update-garage`, {
                ...formData,
                latitude,
                longitude
            });
